...
for i in range(5, 14):
    weekMain = i
    try:
        results = pd.read_csv('./new_csv_data/2018/RESULTS.csv', encoding = "ISO-8859-1")
    ...
    df = pd.read_csv('./new_csv_data/2018/StatsWeek1.csv', encoding = "ISO-8859-1")
    for w in range(2, weekMain):
        df = df.append(pd.read_csv('./new_csv_data/2018/StatsWeek' + str(w) + '.csv', encoding = "ISO-8859-1"), ignore_index=True)
    ...
    #adjAdvStatesCleanUp
    statsTemp = pd.read_csv('./new_csv_data/2018/StatsWeek1.csv', encoding = "ISO-8859-1")
    for w in range(2, weekMain):
        statsTemp = statsTemp.append(pd.read_csv('./new_csv_data/2018/StatsWeek' + str(w) + '.csv', encoding = "ISO-8859-1"), ignore_index=True)
    ...
    bettingW123 = pd.read_csv('./new_csv_Data/2018/BettingLinesWeek1.csv', encoding = "ISO-8859-1")
    for w in range(2, 5):
        bettingW123 = bettingW123.append(pd.read_csv('./new_csv_data/2018/BettingLinesWeek' + str(w) + '.csv', encoding = "ISO-8859-1"), ignore_index=True)
    betting = pd.read_csv('./new_csv_Data/2018/BettingLinesWeek5.csv', encoding = "ISO-8859-1")
    for w in range(6, weekMain + 1):
        betting = betting.append(pd.read_csv('./new_csv_data/2018/BettingLinesWeek' + str(w) + '.csv', encoding = "ISO-8859-1"), ignore_index=True)
    ...
    games = pd.read_csv('./new_csv_Data/2018/BettingLinesWeek' + str(weekMain) + '.csv', encoding = "ISO-8859-1")
    ...
    a.to_csv("./new_csv_Data/2018/predictionsWeek" + str(weekMain) + ".csv")

    week = weekMain

    bets = pd.read_csv('./new_csv_Data/2018/predictionsWeek' + str(week) + '.csv', encoding = "ISO-8859-1")
    ...
    try:
        res = pd.read_csv('./new_csv_Data/2018/RESULTS.csv', encoding = "ISO-8859-1")
        res = res.append(dfFinal)
        res.to_csv('./new_csv_Data/2018/RESULTS.csv', index = False)
    except:
        dfFinal.to_csv('./new_csv_Data/2018/RESULTS.csv', index = False)
